...
import { X, Download, RotateCcw, Search, Maximize2 } from 'lucide-react';
import html2canvas from 'html2canvas';

// 1. ADIÇÃO: Proxy para evitar erro de imagem em branco no download
        ...
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          <div className="flex-1">
            <Card className="bg-slate-900 border-slate-800 p-4 h-[85vh] flex flex-col">
              ...
              <div className="grid grid-cols-3 xl:grid-cols-4 gap-2 overflow-y-auto pr-2 custom-scrollbar">
